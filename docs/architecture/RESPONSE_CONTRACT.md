...
Phase 2 prompt assembly supplies the response planner with bounded identity, recipient, permitted memories, observations, and explicitly untrusted user/platform text sections. Phase 6 observations are rendered as data-only records containing confidence, expiry, provider/model, competing interpretations, OCR data, and evidence IDs; they are not instructions.
